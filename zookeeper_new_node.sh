...
for folder_data in `find ./zookeeper/data -maxdepth 1 -mindepth 1 -type d`
do
    echo $folder_data
    
    # Qtde de caracteres da variavel
    echo ${#folder_data}
    
    # Qtde de caracteres exceto o ultimo
    #export qtde=$((${#folder_data}-1))

    # Pega o ultimo caracter, que eh o ID do Node
    #export valor=${folder_data:$qtde:1}
